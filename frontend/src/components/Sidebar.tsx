  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onOpen}
          className="lg:hidden fixed top-4 left-4 z-50 p-3 bg-white dark:bg-dark-800 rounded-lg shadow-lg border border-gray-200 dark:border-dark-700 hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors"
        >
      ...
      {/* Sidebar */}
      <aside className="w-80 bg-white dark:bg-dark-800 border-r border-gray-200 dark:border-dark-700 lg:block fixed inset-y-0 left-0 z-50 lg:static lg:translate-x-0">
                ...
                <div className="space-y-1">
                  {dashboardSections.map((section) => (
                    <button
                      ...
                      className={`w-full flex items-start px-3 py-2 rounded-lg text-sm font-medium transition-colors text-left ${
                        isActiveSection(section.section)
                          ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300'
                          : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-dark-700'
                      }`}
                    >
                      <section.icon className="mr-3 h-5 w-5 mt-0.5 flex-shrink-0" />
                      <div>
