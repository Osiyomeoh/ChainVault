...
// const CHAINVAULT_CONTRACT = "chainvault-core-v7";
...
//       MOCK_SBTC_CONTRACT,
//       "mint",
//       [Cl.uint(200000000), Cl.principal(wallet1)], // 2 sBTC
//       deployer
//     );
...
//           Cl.buffer(new Uint8Array(32).fill(0xbb)),
//           Cl.uint(72),
//           Cl.uint(300000000), // 3 sBTC (more than deployer has - deployer only has 1 sBTC)
//           Cl.bool(false),
//           Cl.bool(true)
//         ],
//         deployer
...
//       expect(result.result).toBeErr(Cl.uint(107)); // ERR_INSUFFICIENT_BALANCE (user doesn't have enough sBTC)
//     });
...
//     it("supports multiple vaults per user without overwriting", () => {
//       console.log("🧪 Testing multiple vaults per user...");
      
//       // Create first vault
//       const firstVaultResult = simnet.callPublicFn(
//         CHAINVAULT_CONTRACT,
//         "create-sbtc-vault",
//         [
...
//           Cl.stringUtf8("First Vault"),
//           Cl.uint(10), Cl.uint(2),
//           Cl.buffer(new Uint8Array(32).fill(0x01)),
//           Cl.buffer(new Uint8Array(32).fill(0x01)),
//           Cl.uint(5), Cl.uint(100000000), // 1 sBTC
//           Cl.bool(false), Cl.bool(false)
//         ],
//         wallet1
//       );
//       expect(firstVaultResult.result).toBeOk(Cl.stringUtf8("first-vault"));
//       console.log("✅ First vault created successfully");

//       // Check user vaults after first vault
//       const userVaultsAfterFirst = simnet.callReadOnlyFn(
//         CHAINVAULT_CONTRACT,
//         "get-user-vaults",
//         [Cl.principal(wallet1)],
//         wallet1
//       );
//       console.log("🔍 userVaultsAfterFirst.result:", userVaultsAfterFirst.result);
//       console.log("🔍 userVaultsAfterFirst.result type:", typeof userVaultsAfterFirst.result);
//       expect(userVaultsAfterFirst.result).toBeDefined();
//       const firstVaultList = userVaultsAfterFirst.result as any;
//       console.log("🔍 firstVaultList:", firstVaultList);
//       console.log("🔍 firstVaultList.list:", firstVaultList?.list);
//       expect(firstVaultList.value.length).toBe(1);
//       expect(firstVaultList.value[0]).toStrictEqual(Cl.stringUtf8("first-vault"));
//       console.log("✅ First vault correctly stored in user vaults");

//       // Create second vault
//       const secondVaultResult = simnet.callPublicFn(
//         CHAINVAULT_CONTRACT,
//         "create-sbtc-vault",
//         [
//           Cl.stringUtf8("second-vault"),
//           Cl.stringUtf8("Second Vault"),
//           Cl.uint(15), Cl.uint(3),
//           Cl.buffer(new Uint8Array(32).fill(0x02)),
//           Cl.buffer(new Uint8Array(32).fill(0x02)),
//           Cl.uint(7), Cl.uint(50000000), // 0.5 sBTC
//           Cl.bool(true), Cl.bool(true)
//         ],
//         wallet1
//       );
//       expect(secondVaultResult.result).toBeOk(Cl.stringUtf8("second-vault"));
//       console.log("✅ Second vault created successfully");

//       // Check user vaults after second vault - should now have 2 vaults
//       const userVaultsAfterSecond = simnet.callReadOnlyFn(
//         CHAINVAULT_CONTRACT,
//         "get-user-vaults",
//         [Cl.principal(wallet1)],
//         wallet1
//       );
//       expect(userVaultsAfterSecond.result).toBeDefined();
//       const secondVaultList = userVaultsAfterSecond.result as any;
//       expect(secondVaultList.value.length).toBe(2);
      
//       // Check that both vault IDs are present
//       const vaultIds = secondVaultList.value.map((item: any) => item.value);
//       expect(vaultIds).toContain("first-vault");
//       expect(vaultIds).toContain("second-vault");
//       console.log("✅ Second vault correctly appended to user vaults");

//       // Create third vault
//       const thirdVaultResult = simnet.callPublicFn(
//         CHAINVAULT_CONTRACT,
//         "create-sbtc-vault",
//         [
//           Cl.stringUtf8("third-vault"),
//           Cl.stringUtf8("Third Vault"),
//           Cl.uint(20), Cl.uint(1),
//           Cl.buffer(new Uint8Array(32).fill(0x03)),
//           Cl.buffer(new Uint8Array(32).fill(0x03)),
//           Cl.uint(10), Cl.uint(50000000), // 0.5 sBTC
//           Cl.bool(false), Cl.bool(false)
//         ],
//         wallet1
//       );
//       expect(thirdVaultResult.result).toBeOk(Cl.stringUtf8("third-vault"));
//       console.log("✅ Third vault created successfully");

//       // Check user vaults after third vault - should now have 3 vaults
//       const userVaultsAfterThird = simnet.callReadOnlyFn(
//         CHAINVAULT_CONTRACT,
//         "get-user-vaults",
//         [Cl.principal(wallet1)],
//         wallet1
//       );
//       expect(userVaultsAfterThird.result).toBeDefined();
//       const thirdVaultList = userVaultsAfterThird.result as any;
//       expect(thirdVaultList.value.length).toBe(3);
      
//       // Check that all three vault IDs are present
//       const finalVaultIds = thirdVaultList.value.map((item: any) => item.value);
//       expect(finalVaultIds).toContain("first-vault");
//       expect(finalVaultIds).toContain("second-vault");
//       expect(finalVaultIds).toContain("third-vault");
//       console.log("✅ Third vault correctly appended to user vaults");

//       console.log("✅ Multiple vaults test completed successfully!");
